...
<!-- show this code for sucessful, registration -->
  ...
  @if(Session::get('order-status') == 'placed');
        ...
        var google_conversion_label = "41xnCN2etHMQsdCO_QM";
        ...
        <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1067690033/?label=41xnCN2etHMQsdCO_QM&amp;guid=ON&amp;script=0"/>
        </div>
        </noscript>
    @endif
